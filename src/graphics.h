...
/* TODO: Make the screen depth variable at runtime. */
...
GEO_COLOR* graphics_create_color( unsigned char, unsigned char, unsigned char );
GEO_COLOR* graphics_create_color_html( bstring );
